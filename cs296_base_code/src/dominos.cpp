	...
	//#include <conio.h>
	 ...
	 //! defining shapes
	  ...
	  revoluteJointDef7A2.localAnchorA.Set(-4.5,0);//! set local anchor A at (-4.5,0) wrt its center
	  ...
	  revoluteJointDef7A3.localAnchorA.Set(4.5,0);//! set local anchor A at (4.5,0) wrt its center
	 ...
	 //! spear's corner tringle
	  ...
	  if(dummy1&&((int)(m_bodyG1->GetPosition().x-x1)/4%2==1)){//!when distance of body/4 is odd
	       if(m_bodyG1->GetLinearVelocity().x<30)
	  ...
	  if(dummy1&&((int)(m_bodyG1->GetPosition().x-x1)/4%2==0)){//! if distance/4 is even
